...
public class PrimeiroController3 {
    ...
    private void secondFloorButtonClick() {
        ...
        alert.setTitle("Trajetória");
        alert.setHeaderText(null);
        alert.setContentText("Você escolheu o 2° andar como destino:\n"
        		+ " >o elevador chega no segundo andar.");
        alert.showAndWait();  
    	try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("elevadorSegundoDentroInterfacePA.fxml"));
            Parent root = loader.load();
    ...
    private void firstFloorButtonClick() {
        ...
        alert.setTitle("Você está no 1° andar");
        alert.setHeaderText(null);
    ...
    private void groundFloorButtonClick() {
        ...
        alert.setContentText("Você escolheu o Térreo como destino:\n"
        		+ " >o elevador passa pelo segundo andar\n"
    ...
    private void portaImageViewClicked(MouseEvent event) {
    	try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("elevadorPrimeiroForaInterfacePF.fxml"));
            Parent root = loader.load();
