...
public class TerceiroController3 {
    ...
    private void thirdFloorButtonClick() {
        ...
        alert.setTitle("Você está no 3° andar");
        alert.setHeaderText(null);
    ...
    private void portaImageViewClicked(MouseEvent event) {
    	try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("elevadorTerceiroForaInterfacePF.fxml"));
            Parent root = loader.load();
