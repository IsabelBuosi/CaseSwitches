...
public class KitkatController {
    ...
    private final double precoDoce = 6.00;
    ...
    private void cancelarButtonClick() {
        ...
        alert.setContentText(String.format("A compra do KitKat foi cancelada."
    ...
    private void exibirMensagemSucesso(double troco) {
        ...
        alert.setContentText(String.format("O KitKat foi comprado com sucesso! Seu troco é: R$%.2f", troco));
        alert.showAndWait();
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("maquinaDocesInterface.fxml"));
            Parent root = loader.load();
